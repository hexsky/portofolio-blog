...
@section('content')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-100">Selamat Datang di Portofolio Saya</h1>
        <p class="mt-4 text-lg text-gray-600 dark:text-gray-300">Saya adalah seorang kreator yang bersemangat dalam Desain dan Pengembangan Web.</p>
        <div class="mt-8">
            ...
            @forelse ($portfolios as $portfolio)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-4">{{ Str::limit($portfolio->description, 100) }}</p>
    ...
    <section>
        ...
        <div class="space-y-6 max-w-4xl mx-auto">
            @forelse ($posts as $post)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 mt-4">{{ Str::limit(strip_tags($post->content), 200) }}</p>
                    <a href="{{ route('blog.show', $post->slug) }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-200 font-semibold mt-4 inline-block">Baca Selengkapnya →</a>
                </div>
            @empty
        ...
        <div class="text-center mt-8">
            <a href="{{ route('blog.public') }}" class="text-gray-700 dark:text-gray-300 font-semibold hover:text-indigo-600 dark:hover:text-indigo-400">Lihat Semua Tulisan</a>
        </div>
    </section>
@endsection
