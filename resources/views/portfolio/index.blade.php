...
@section('content')
    <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900">Portofolio Saya</h1>
        <p class="mt-4 text-lg text-gray-600">Berikut adalah beberapa karya yang pernah saya buat.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @empty
            ...
            <div class="col-span-3 text-center py-12">
                <p class="text-gray-500 text-lg">Belum ada item portofolio yang dipublikasikan.</p>
            </div>
        @endforelse
    </div>
@endsection
