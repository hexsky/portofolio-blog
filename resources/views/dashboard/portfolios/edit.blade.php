                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('portfolios.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="category" name="category" type="text" class="mt-1 block w-full" :value="old('category', $portfolio->category)" required />
                        ...
                        <div>
                            ...
                            <img src="{{ asset('images/portfolios/'.$portfolio->image) }}" class="mt-2 rounded-md h-24 w-auto" alt="Gambar saat ini">
